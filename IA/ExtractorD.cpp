...
{
	return std::string("D") + ExtractorConstructor::generateRandomExtractorCode(i, ExtractorType::UNIT) + ExtractorConstructor::generateRandomExtractorCode(i, ExtractorType::POINT_E);
}
