...
std::string ExtractorNH::generateRandomCode(int i)
{
	return std::string("NH") + std::to_string(rand() % 7) + std::to_string(rand() % 10) + ExtractorConstructor::generateRandomExtractorCode(i, ExtractorType::ARMY);
}